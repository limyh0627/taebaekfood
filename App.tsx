...
// --- INITIAL DATA ---
// 회사 전용 초기 데이터는 src/config/company.ts 에서 관리합니다.
// 다른 회사에 납품할 때는 그 파일만 교체하면 됩니다.
...
const App: React.FC = () => {
  ...
  // 관리자 전용 데이터 — isAdmin일 때만 Firebase 구독 시작
  const { fixedCosts, productionRecords } = useAdminData(isAdmin);
