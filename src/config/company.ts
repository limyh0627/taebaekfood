...
export const INITIAL_PRODUCTS: Item[] = [
  ...
  { id: 'p3', name: '생들기름 (180ml)', type: 'product', stock: 15, minStock: 50, unit: '개', image: '' },
  { id: 'p7', name: '골드캡 마개', type: 'cap', stock: 120, minStock: 1000, unit: '개', image: '' },
  { id: 'p8', name: '태백 로고 테이프', type: 'tape', stock: 45, minStock: 20, unit: '롤', image: '' },
  { id: 'sub-01', name: '300ml 유리용기', type: 'container', stock: 1200, minStock: 500, unit: '개', image: '' },
  { id: 'sub-02', name: '참기름 전용 박스', type: 'box', stock: 800, minStock: 200, unit: '개', image: '' },
  { id: 'sub-03', name: '들기름 전용 박스', type: 'box', stock: 600, minStock: 200, unit: '개', image: '' },
  { id: 'gck-1', name: '고춧가루 1kg', type: 'product', category: '고춧가루', stock: 0, minStock: 0, unit: '개', image: '' },
  { id: 'gck-5', name: '고춧가루 5kg', type: 'product', category: '고춧가루', stock: 0, minStock: 0, unit: '개', image: '' },
];
