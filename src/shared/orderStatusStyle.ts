 ...
 *   예전 주문 **회색** — 끝나서 물러난 것
 *
 * 색을 한 칸씩 옮긴 내력(2026-09-14 사장님) — 먼저 "대기중 분홍색으로 한번 바꿔봐" 로
 * 대기중에 분홍을 입혀 봤고, 보시고는 "작업중 카드 색깔을 이걸로 바꾸고 출고완료 카드 색에
 * 작업중 색을 써" 로 정하셨다. 그래서 분홍은 작업중으로, 하늘은 출고완료로 내려갔고
 * 대기중은 노랑으로 돌아왔다. 남색은 이제 상태 색으로 안 쓴다.
 *
...
export const STATUS_COLOR: Record<string, string> = {
  ...
  [OrderStatus.PROCESSING]: 'bg-pink-100 text-pink-700',
...
export const STATUS_HEAD: Record<string, string> = {
  ...
  [OrderStatus.PROCESSING]: 'bg-pink-100 text-pink-800',
...
export const STATUS_CARD_BORDER: Record<string, string> = {
  ...
  [OrderStatus.PROCESSING]: 'border-pink-400',
...
export const STATUS_HEAD_LINE: Record<string, string> = {
  [OrderStatus.PENDING]: 'text-amber-800',
  [OrderStatus.PROCESSING]: 'text-pink-800',
...
export const CARD_HEADER_COLOR: Record<string, string> = {
  ...
  [OrderStatus.PROCESSING]: 'bg-pink-200 border-pink-300',
...
const BORDER: Record<string, string> = {
  ...
  [OrderStatus.PROCESSING]: 'border-pink-200',
...
const TEXT_500: Record<string, string> = {
  ...
  [OrderStatus.PROCESSING]: 'text-pink-500',
...
const BG_500: Record<string, string> = {
  ...
  [OrderStatus.PROCESSING]: 'bg-pink-500',
...
const BG_SOFT: Record<string, string> = {
  ...
  [OrderStatus.PROCESSING]: 'bg-pink-50/50',
...
const BORDER_SOFT: Record<string, string> = {
  ...
  [OrderStatus.PROCESSING]: 'border-pink-100',
...
const TEXT_700: Record<string, string> = {
  ...
  [OrderStatus.PROCESSING]: 'text-pink-700',
