...
export interface Item {
   ...
   * 과세 여부. 안 정하면 **과세**다.
   *
   * 원가에 걸린다 — 면세 원료(참깨·들깨 같은 농산물)로 과세품을 만들면 매입세액을 못 빼서
   * 그만큼이 그대로 원가에 얹힌다(bomCost의 vatUp, ×1.1). 원료가 과세면 빼므로 단가 그대로.
   */
  taxType?: '과세' | '면세';
  price: number;
  /**
