...
import { Order, OrderItem, Item, OrderStatus, AppNotification, Partner, RawMaterialLot, companyOf } from '../../shared/types';
import { toKg, baseRawName, unitToKg } from '../../constants/formula';
import { deductLotsByQty, restoreLotsByQty } from '../../shared/lotUtils';
...
export function createOrderStockEngine(deps: OrderStockEngineDeps) {
  const { actorName, allItems, submaterials, partners, allOrders, orders, db,
    ...
    runRawInventoryJob: runRawJob = runRawInventoryJob } = deps;
