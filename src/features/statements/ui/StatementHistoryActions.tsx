      ...
      <div className="flex shrink-0 flex-wrap items-center gap-2">
        <div className="relative" ref={menuRef}>
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl bg-indigo-600 px-3 py-2 text-xs font-black text-white shadow-sm shadow-indigo-200 transition-all hover:bg-indigo-500"
          >
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-xl bg-teal-600 px-3 py-2 text-xs font-black text-white shadow-sm shadow-teal-200 transition-all hover:bg-teal-500"
        ...
        {onOpenRecurring && (
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl bg-violet-600 px-3 py-2 text-xs font-black text-white shadow-sm shadow-violet-200 transition-all hover:bg-violet-500"
