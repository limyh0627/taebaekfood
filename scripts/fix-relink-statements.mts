...
const LINKS: [string, string, string][] = [
  ...
  // 4차 — 수량이 달랐던 건. 사장님 확인: "전표가 맞아" (주문 쪽이 틀렸다)
  ['260803-11', 'ORD-1785830866346', '청정식품 08-03 — 볶음참깨 480·들깨가루 20은 일치. 셋째 줄은 주문 특A/1800ml ×36 vs 전표 A/1750ml ×30으로 달랐는데 사장님 확인상 전표가 맞다'],
